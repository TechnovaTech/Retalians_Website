        ...
        <div className="container mx-auto px-4 text-center text-white relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed">
              Streamline your clothing business with our all-in-one platform. From inventory management to POS systems, we've got everything covered.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive ERP solution is specifically designed for clothing and fashion retail businesses.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Built specifically for fashion retail with features that matter most to your business.
            </p>
          </div>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90">
            Join thousands of fashion retailers who have streamlined their operations with our ERP solution.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-8 py-4 text-lg">
